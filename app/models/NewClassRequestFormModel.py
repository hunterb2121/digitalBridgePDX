...
class NewClassRequestFormModel(BaseModel):
    table = "new_class_request_form"

    def __init__(self, id, name, email, phone_number, class_idea, status, submitted_date):
        self._id = id
        self._name = name
        self._email = email
        self._phone_number = phone_number
        self._class_idea = class_idea
        self._status = status
